...
function spin() {
    ...
    let Hasil = shuffle([MagicRoaster[0], Sepeda[0], RiceCooker[0], LunchBox[0], Sanken[0], Electrolux[0], JblSpeaker[0]]);
    // console.log(Hasil[0]);
    ...
    setTimeout(function () {
        ...
        Notiflix.Report.Success("Congratulations", "You Won The " + SelectedItem + ".", "Ok");
    }, 5500);
