   ...
   function (t) {
      ...
      var e,
         ...
         u = function () {
            if (
               null !== b() &&
               !t.document.getElementById("NotiflixInternalCSS")
            ) {
               if (!g("head")) return !1;
         ...
         B = function (a, o, n, r) {
            ...
            (x.id = e.ID + "-" + A),
               ...
               e.rtl &&
                  (x.setAttribute("dir", "rtl"), x.classList.add("rtl-on")),
            ...
            if (h) {
               var v,
                  N = t.document.getElementById(f.id);
         ...
         F = function (e, a, o, n, r, l) {
            ...
            (d.id = c.ID),
               ...
               i.rtl &&
                  (d.setAttribute("dir", "rtl"), d.classList.add("rtl-on")),
         ...
         D = function (e, i, a, n, r) {
            ...
            if (("string" == typeof e && 0 < e.length && (m = e), n)) {
               m =
                  m.toString().length > o.messageMaxLength
                     ? k(m).toString().substring(0, o.messageMaxLength) + "..."
                     : k(m).toString();
               var f = "";
               0 < m.length &&
                  (f =
               ...
               if (
                  ...
                  o.rtl &&
                     (v.setAttribute("dir", "rtl"), v.classList.add("rtl-on")),
                  (v.innerHTML = h + f),
            ...
            if (e)
               for (var z = 0; z < N; z++) {
                  ...
                  if (1 > A.length) {
                     ...
                     o &&
                        ("hourglass" === o
                           ? (X = W(n.svgSize, n.svgColor))
                           : "circle" === o
                           ? (X = S(n.svgSize, n.svgColor))
                           : "arrows" === o
                           ? (X = L(n.svgSize, n.svgColor))
                           : "dots" === o
                           ? (X = I(n.svgSize, n.svgColor))
                           : "pulse" === o
                           ? (X = R(n.svgSize, n.svgColor))
                     ...
                     0 < w.length &&
                        ((w =
                           w.length > n.messageMaxLength
                              ? k(w).substring(0, n.messageMaxLength) + "..."
                              : k(w)),
                        (F =
                     ...
                     Y = M.getAttribute("id")
                        ...
                        : M.classList[0]
                        ? "." + M.classList[0]
                        : (M.tagName || "").toLocaleLowerCase("en");
                     var G = "",
                        U =
                           -1 >=
                  ...
                  J = function (t) {
                     if (t && 0 < t.length)
                        for (var e, o = 0; o < t.length; o++)
                           (e = t[o]), e && (e.classList.add("remove"), $(e));
                     else
                        x(
                           "Notiflix Info",
